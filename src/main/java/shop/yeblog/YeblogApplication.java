...
public class YeblogApplication extends DummyEntity {
  ...
  CommandLineRunner init(UserRepository userRepository, BoardRepository boardRepository, ReplyRepository replyRepository, BCryptPasswordEncoder passwordEncoder){
    return args -> {
